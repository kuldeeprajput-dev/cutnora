...
export function LayerOperations({ clip }: LayerOperationsProps) {
  ...
  return (
    <div className="flex flex-col gap-3 text-[#F4F5F7] border-t border-[#2B2F38] pt-4 mt-4">
      <label className="text-[11px] font-medium text-[#9298A3]">Layer Operations</label>
      ...
      <div className="grid grid-cols-2 gap-2">
        <Button size="sm" variant="secondary" onClick={handleBringForward} disabled={trackIndex >= totalTracks - 1} className="text-xs justify-start gap-1.5">
          <ArrowUp className="h-3.5 w-3.5 text-[#FF5A36]" /> Bring Forward
        </Button>
        <Button size="sm" variant="secondary" onClick={handleSendBackward} disabled={trackIndex <= 0} className="text-xs justify-start gap-1.5">
          <ArrowDown className="h-3.5 w-3.5 text-[#3478D4]" /> Send Backward
        </Button>
      ...
      <div className="grid grid-cols-2 gap-2">
        <Button size="sm" variant="secondary" onClick={handleDuplicate} className="text-xs justify-start gap-1.5">
          <Copy className="h-3.5 w-3.5 text-[#F2C94C]" /> Duplicate
        </Button>
        ...
        <Button size="sm" variant="ghost" onClick={handleDelete} className="text-xs justify-start gap-1.5 text-[#E45858] hover:bg-[#E45858]/10">
